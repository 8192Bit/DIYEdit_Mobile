...
public class Metadata {
            ...
            if ((file[i] & 0xFF) >= 0x80) // Unicode-type thing
            {
                if ((file[i] & 0xFF) >= 0xE0) // Japan, why u have 3 byte letters
                {
                    ...
                    if (Globals.translation.containsKey(key))
                        ...
                        bbb[1] = file[i + 1];
                        bbb[2] = file[i + 2];
                        name.append(new String(bbb, StandardCharsets.UTF_8));
                    } else
                        name.append("?");
                    i++;
                    i++;
            ...
            if ((file[i] & 0xFF) >= 0x80) // Unicode-type thing
            {
                if ((file[i] & 0xFF) >= 0xE0) // Japan, why u have 3 byte letters
                {
                    ...
                    if (Globals.translation.containsKey(key))
                        ...
                        bbb[1] = file[i + 1];
                        bbb[2] = file[i + 2];
                        desc.append(new String(bbb, StandardCharsets.UTF_8));
                    } else
                        desc.append("?");
                    i++;
                    i++;
            ...
            if ((file[i] & 0xFF) >= 0x80) // Unicode-type thing
            {
                if ((file[i] & 0xFF) >= 0xE0) // Japan, why u have 3 byte letters
                {
                    ...
                    if (Globals.translation.containsKey(key))
                        ...
                        bbb[1] = file[i + 1];
                        bbb[2] = file[i + 2];
                        brand.append(new String(bbb, StandardCharsets.UTF_8));
                    } else
                        brand.append("?");
                    i++;
                    i++;
            ...
            if ((file[i] & 0xFF) >= 0x80) // Unicode-type thing
            {
                if ((file[i] & 0xFF) >= 0xE0) // Japan, why u have 3 byte letters
                {
                    ...
                    if (Globals.translation.containsKey(key))
                        ...
                        bbb[1] = file[i + 1];
                        bbb[2] = file[i + 2];
                        cr.append(new String(bbb, StandardCharsets.UTF_8));
                    } else
                        cr.append("?");
                    i++;
                    i++;
    ...
    public int getSerial2() {
        ...
        if (tmp3.length() > 2) {
            tmp3 = tmp3.substring(tmp3.length() - 2);
        }
