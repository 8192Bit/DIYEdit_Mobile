...
public class SaveHandler {
    ...
    public SaveHandler(String savename) {
        ...
        nam = savename;
        if (saveFile.length == 33554432 || saveFile.length == 33566720 || saveFile.length == 33554554 || nam.endsWith(".dsv") || saveFile.length == 16777216) {
    ...
    public byte[] getMio(int mode, int mionumber) // Filename is the save file name
    {
        ...
        } else if (saveFile.length == 33554432 || saveFile.length == 33566720 || saveFile.length == 33554554) { // dsmode=0-2 (Games, Records, Comics), mionumber=0-89
