...
public class SaveEditFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        gv = requireView().findViewById(R.id.save_shelf_gv);

        MaterialButton diy1 = requireView().findViewById(R.id.save_shelf_1_btn);
        MaterialButton diy2 = requireView().findViewById(R.id.save_shelf_2_btn);
        MaterialButton diy3 = requireView().findViewById(R.id.save_shelf_3_btn);
        MaterialButton diy4 = requireView().findViewById(R.id.save_shelf_4_btn);
        MaterialButton diy5 = requireView().findViewById(R.id.save_shelf_5_btn);
        int length = FileByteOperations.read(name).length;
        if (length == 4719808 || length == 591040 || length == 1033408 || length == 6438592) {
            ((LinearLayout) requireView().findViewById(R.id.save_shelf_select_ll)).removeView(diy5);
        } else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.save_edit_fragment, container, true);
    }
    ...
    private void showMioPopupMenu(View view, int count) {
        ...
        popupMenu.inflate(R.menu.mio_menu);
        popupMenu.setOnMenuItemClickListener(item -> {
            ...
            if (item.getItemId() == R.id.extract_file) {
                Intent intent = new Intent(OPEN_FILE_CHOOSE_ACTIVITY);
                intent.putExtra(IS_SAVE_EDIT, true);
    ...
    public class SaveItemAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = layoutInflater.inflate(R.layout.shelf_item, null);
                holder = new ViewHolder();
                holder.iv = convertView.findViewById(R.id.shelf_iv);
                holder.tv = convertView.findViewById(R.id.shelf_tv);
