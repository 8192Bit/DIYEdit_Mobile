...
public class AudioSystem {
	 ...
	 *
	 * @param format an <code>AudioFormat</code> object specifying the supported
	 *               audio format of the returned line, or <code>null</code> for
	 *               any audio format
	 * @return the desired <code>SourceDataLine</code> object
	 * @throws LineUnavailableException if a matching source data line is not available due to
	 *                                  resource restrictions
	 * @throws SecurityException        if a matching source data line is not available due to
	 *                                  security restrictions
	 * @throws IllegalArgumentException if the system does not support at least one source data line
	 ...
	 * audio file format
	 * @throws UnsupportedAudioFileException if the stream does not point to valid audio file data
	 ...
	 * @throws IllegalArgumentException if the conversion is not supported #see
	 ...
	 * converters.
	 *
	 * @param sourceEncoding the encoding for which conversion support is queried
	 ...
	 *
	 * @param file the <code>File</code> for which the
	 *             <code>AudioInputStream</code> should be constructed
	 * @return an <code>AudioInputStream</code> object based on the audio file
	 * data pointed to by the <code>File</code>
	 * @throws UnsupportedAudioFileException if the <code>File</code> does not point to valid audio file
	 ...
	 * @throws UnsupportedAudioFileException if the URL does not point to valid audio file data recognized
	 *                                       by the system
	 * @throws IOException                   if an I/O exception occurs
	 */
