 ...
 * @{
 */
FLUIDSYNTH_API fluid_istream_t

fluid_get_stdin(void);

FLUIDSYNTH_API fluid_ostream_t
...
FLUIDSYNTH_API
        fluid_cmd_handler_t
*
new_fluid_cmd_handler(fluid_synth_t
*synth,
...
FLUIDSYNTH_API
        fluid_cmd_handler_t
*
new_fluid_cmd_handler2(fluid_settings_t
*settings,
fluid_synth_t *synth,
        fluid_midi_router_t
*router,
...
const char *cmd, fluid_ostream_t
out);
...
FLUIDSYNTH_API
        fluid_shell_t
*
new_fluid_shell(fluid_settings_t
*settings,
...
FLUIDSYNTH_API
        fluid_server_t
*
new_fluid_server(fluid_settings_t
*settings,
fluid_synth_t *synth, fluid_midi_router_t
*router);

FLUIDSYNTH_API
        fluid_server_t
*
new_fluid_server2(fluid_settings_t
*settings,
fluid_synth_t *synth, fluid_midi_router_t
*router,
fluid_player_t *player
