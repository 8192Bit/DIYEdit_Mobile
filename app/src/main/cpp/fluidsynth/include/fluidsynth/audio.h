...
*
new_fluid_audio_driver(fluid_settings_t
*settings,
fluid_synth_t *synth
);
...
FLUIDSYNTH_API fluid_audio_driver_t
*
new_fluid_audio_driver2(fluid_settings_t
*settings,
...
*
new_fluid_file_renderer(fluid_synth_t
*synth);
...
FLUIDSYNTH_API int fluid_file_set_encoding_quality(fluid_file_renderer_t * dev, double
q);
/** @} */
