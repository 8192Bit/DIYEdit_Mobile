...
FLUIDSYNTH_API fluid_sfloader_t
*
new_fluid_sfloader(fluid_sfloader_load_t
load,
...
*
new_fluid_sfont(fluid_sfont_get_name_t
get_name,
 ...
 */
typedef int (*fluid_preset_noteon_t)(fluid_preset_t * preset, fluid_synth_t * synth, int
chan,
int key,
int vel
);
