...
FLUIDSYNTH_API int fluid_midi_event_set_key(fluid_midi_event_t * evt, int
key);
...
*
new_fluid_midi_router(fluid_settings_t
*settings,
...
FLUIDSYNTH_API int fluid_midi_router_add_rule(fluid_midi_router_t * router,
                                              fluid_midi_router_rule_t * rule, int
type);
...
FLUIDSYNTH_API
        fluid_midi_driver_t
*
new_fluid_midi_driver(fluid_settings_t
*settings,
handle_midi_event_func_t handler,
void *event_handler_data
);
...
*
new_fluid_player(fluid_synth_t
*synth);
...
loop);
FLUIDSYNTH_API int fluid_player_set_tempo(fluid_player_t * player, int
tempo_type,
double tempo
);
FLUID_DEPRECATED FLUIDSYNTH_API
int fluid_player_set_midi_tempo(fluid_player_t * player, int
tempo);
FLUID_DEPRECATED FLUIDSYNTH_API
int fluid_player_set_bpm(fluid_player_t * player, int
bpm);
...
FLUIDSYNTH_API int fluid_player_set_tick_callback(fluid_player_t * player, handle_midi_tick_func_t
handler,
void *handler_data
);
...
FLUIDSYNTH_API int fluid_player_seek(fluid_player_t * player, int
ticks);
/** @} */
